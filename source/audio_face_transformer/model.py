...
class CustomModel(CustomModelBase):
    ...
    def __init__(
        ...
        # Linear layers to project inputs to d_model dimension
        self.project_audio = nn.Linear(audio_last_layer_num, d_model)
        self.project_image = nn.Linear(face_last_layer_num, d_model)
        self.project_text = nn.Linear(input_shapes[2], d_model)
